    ...
    @if($customers->isEmpty())
        <x-filament::section>
            <div class="flex flex-col items-center justify-center py-12 text-gray-500 dark:text-gray-400">
                ...
                <h3 class="text-base font-medium text-gray-900 dark:text-white mb-1">No Managed Services Yet</h3>
                <p class="text-sm">There are no customers with active Managed Services to display.</p>
            </div>
        </x-filament::section>
    @else
        <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
            @foreach($customers as $customer)
                <button
                    ...
                    wire:key="ms-overview-card-{{ $customer['customer_id'] }}"
                ...
                >
                    <div class="flex items-start justify-between mb-3">
                        ...
                        <span class="inline-flex px-2 py-0.5 rounded text-xs font-semibold bg-primary-50 dark:bg-primary-900/30 text-primary-700 dark:text-primary-300">
                            {{ $customer['service_count'] }} services
                        </span>
                    </div>
